...
public class ForLoops01 {
    public static void main(String[] args) {
        ...
        //Dongüler (Loops) tekrar eden kodlama islerini kolaylastirmak icin kullanilir
        //Tum kod parcalarini belirli bir kural dongusu icinde tekrarlamak icin kullanilir




        /*Java'da su donguleri gorecegiz 1. for-loop 2. while-loop 3. do-while-loop 4. for-each-loop (Collections'larda)*/
/*1. for-loop
