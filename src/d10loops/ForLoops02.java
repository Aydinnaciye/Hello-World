...
public class ForLoops02 {
  ...
  /*Ornek 1: Verilen bir String'de ilk 'a' harfinden onceki tum character'leri console'a yazdiriniz
        ...
        for (int i = 0; i < s1.length(); i++) { //length 1 ile baslar
            char ch = s1.charAt(i); //Burda indexe bakariz.Ilk index 0 dir.
        ...
        String t = "Java";
        String reverse = ""; //reverse nin yeni degeri a oldu.Sonra av oldu,ava oldu,avaJ oldu //ters cevirince bunun icinde saklayacagiz

        for (int i = t.length() - 1;     i >= 0 ; i--) {
                 //i=3
            reverse = reverse + t.charAt(i);
         //   System.out.println("loop ici : "+ reverse);//Soutu for un icine yazarsak bütün asamalari gösterir.
        }
